    ...
    attach: function (context, settings) {
      setTimeout(function () {
        ...
        $('#detectorstem_was_generated_by').on('change', function () {
          ...
          var $errorMessage = $('#detectorstem_language_error');
          ...
          if (selectedValue === translation) {
            ...
            if (!$errorMessage.length) {
              $languageField.after('<div id="detectorstem_language_error" style="color: red;">Must select a different Language.</div>');
            }
            ...
            $('#detectorstem_language_error').remove();
          }
        });
      }, 1000);
    }
